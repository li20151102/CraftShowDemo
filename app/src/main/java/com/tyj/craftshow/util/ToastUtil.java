...
/**
 * @author create by kyle_2019 on 2019/5/17 11:08
 * @package com.tyj.craftshow.util
 * @fileName ToastUtil
 */
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        if(AppApplication.getContext() != null){
            ...
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(AppApplication.getContext(),64));
            toast.show();
        }
    }
    /**
    ...
    public static void showLongToast(String msg) {
        if(AppApplication.getContext() != null) {
            if (toast == null) {
                toast = Toast.makeText(AppApplication.getContext(), msg, Toast.LENGTH_LONG);
            } else {
                toast.setText(msg);
            }
            toast.setGravity(Gravity.BOTTOM, 0, dip2px(AppApplication.getContext(),64));
